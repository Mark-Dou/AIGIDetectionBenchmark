...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--detection_model', type=str, choices=['LGrad', 'LNP', 'GramNet', 'FreDect',
                                                                    'CNNSpot', 'UnivFD', 'NPR', 'SAFE',
                                                                    'SimE', 'FatFormer'], help='model for Ai-generated image detection')
        ...
        parser.add_argument('--device', type=str, default='cuda:0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        ...
        # LGrad params
        parser.add_argument('--LGrad_modelpath', type=str,
                            default='./weights/preprocessing/karras2019stylegan-bedrooms-256x256_discriminator.pth',
                            help='the path of LGrad pre-trained model')

        # LNP params
        parser.add_argument('--LNP_modelpath', type=str, default='./weights/preprocessing/sidd_rgb.pth',
