...
class Dataset_Creator:
    def __init__(self, dataset_path, batch_size, num_workers=0, img_resolution=256, crop_resolution=224):
        ...
        self.all_dataset = {
            "train": ["airplane", "bird", "bottle", "car", "chair", "diningtable", "horse", "person", "sheep", "train", "bicycle", "boat", "bus", "cat", "cow", "dog", "motorbike", "pottedplant", "sofa", "tvmonitor"],
...
class Dataset_Creator_4classes:
    def __init__(self, dataset_path, batch_size, num_workers=0, img_resolution=256, crop_resolution=224):
        self.dataset_path = dataset_path
        self.batch_size = batch_size
        self.num_workers = num_workers
        ...
        self.all_dataset = {
            "train": ["car", "cat", "chair", "horse"],
            "val": ["airplane", "bird", "bottle", "car", "chair", "diningtable", "horse", "person", "sheep", "train",
                    "bicycle", "boat", "bus", "cat", "cow", "dog", "motorbike", "pottedplant", "sofa", "tvmonitor"],
            "test": ["biggan", "crn", "cyclegan", "deepfake", "gaugan", "imle", "progan", "san", "seeingdark",
                     "stargan", "stylegan", "stylegan2", "whichfaceisreal", "DDPM", "DMBGIS", "IDDPM", "LDM", "PDS",
                     "PNDM", "STSP4"] + ['dalle', 'glide_50_27', 'glide_100_10', 'glide_100_27', 'guided', 'ldm_100',
                                         'ldm_200', 'ldm_200_cfg']
        }
