...
from utils.dataset import Dataset_Creator, Dataset_Creator_4classes
...
def get_args_parser():
    ...
    parser.add_argument('--save_dir', type=str, default="/data/home/wanghy/FatFormer/results")
...
def main(args):
    ...
    # training dataset
    dataset_creator = Dataset_Creator(dataset_path=args.dataset_path, batch_size=args.batchsize,
